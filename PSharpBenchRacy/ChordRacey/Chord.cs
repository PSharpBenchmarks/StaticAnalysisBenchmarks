...
namespace ChordRacey
{
    ...
    internal class Message
    {
        ...
        public Message(Machine machine, int id)
        {
    ...
    internal class ChordNode : Machine
    {
        ...
        private void FindSuccessor()
        {
            ...
            {
                message = new Message(this.FingerTable[(this.Id + 1) % this.NumOfId].Item3, id);
                this.Send(sender, new eFindSuccessorResp(message));
                this.Message = message;
            }
            else
        ...
        private void SuccessorFound()
        {
            ...
            var successor = ((Message)this.Payload).Machine;
